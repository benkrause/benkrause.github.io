...
####[Achieving human-level text prediction ](./human-level-text-prediction/)  
**Date**: July 27, 2018 <br/>
**TLDR**: I briefly review classic experiments in estimating the entropy of the English language, and compare of state of the art deep learning models and humans at predicting the same chunk of text.
